...
# # for each color a solid color pen of width 1 is build as default

# # pens
# from wx import Pen, PENSTYLE_SOLID
# _pens = {}

# def createSolidPen(name, colour):
#     pen = Pen()
#     pen.SetWidth(1)
#     pen.SetStyle(PENSTYLE_SOLID)
#     pen.SetColour(_colours[colour])
#     _pens[name] = pen

# for c in _colours.keys():
#     createSolidPen(c, c)

# # plus a transparent pen
# from wx import PENSTYLE_TRANSPARENT
# pen = Pen()
# pen.SetWidth(1)
# pen.SetStyle(PENSTYLE_SOLID)
# pen.SetColour(_colours[colour])
# _pens['transparent'] = pen
# del pen
